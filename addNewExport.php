...
require_once ('dbhelp.php');
	...
	if (!empty($_POST)) {
        ...
        $sql = 'select * from export where id_note =' .$_POST['nid'];
		...
		if (empty($error)) {
			$sql = "insert into export(id_note,n_staff,time,storage_address,n_book,id_book,amount_of_book,current_price_of_book,id_staff) value('$s_id', '$s_sname', '$s_time', '$s_address', '$s_bname', '$s_bid', '$s_ammount', '$s_price', '$s_sid')";
			execute($sql);
...
<html>
<head>
	<title>Add New Export Note</title>
	...
	<div class="container">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h2 class="text-center">Thêm thông tin xuất kho mới</h2>
			</div>
